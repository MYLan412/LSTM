...
model.save("Model/cnn_lstm_for_GRU_model.h5")
...
import json
json.dump(history.history,open("cnn_lstm_for_GRU_history.json","w"))


# In[12]:


model_restored=tf.keras.models.load_model("Model/cnn_lstm_for_GRU_model.h5")
...
lstm_model=GRU(units=80,return_sequences=True,kernel_initializer=initializers.glorot_uniform(seed=2022),recurrent_initializer=initializers.orthogonal(seed=2022))(inputs)
# lstm_model=PeepholeLSTMCell(80)(inputs)#
...
lstm_model.save("Model/GRU_model.h5")
...
import json
json.dump(history.history,open("GRU_history.json","w"))


# In[26]:


model_restored=tf.keras.models.load_model("Model/GRU_model.h5")
