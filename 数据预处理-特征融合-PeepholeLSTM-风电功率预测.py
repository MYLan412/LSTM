...
model.save("Model/cnn_lstm_for_PLSTM_model.h5")
...
import json
json.dump(history.history,open("cnn_lstm_for_PLSTM_history.json","w"))


# In[12]:


model_restored=tf.keras.models.load_model("Model/cnn_lstm_for_PLSTM_model.h5")
...
lstm_model=RNN(PeepholeLSTMCell(80))(inputs)#
...
lstm_model.save("Model/PeepholeLSTM_model.h5")
...
import json
json.dump(history.history,open("PeepholeLSTM_history.json","w"))


# In[27]:


model_restored=tf.keras.models.load_model("Model/PeepholeLSTM_model.h5")
