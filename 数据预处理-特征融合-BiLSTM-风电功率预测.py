...
model.save("Model/cnn_lstm_for_BiLSTM_model.h5")
...
import json
json.dump(history.history,open("cnn_lstm_for_BiLSTM_history.json","w"))


# In[12]:


model_restored=tf.keras.models.load_model("Model/cnn_lstm_for_BiLSTM_model.h5")
...
# # R2 0.9406061865772037
# # MSE 0.0011699123645626643
# # MAE 0.023751736868387423
# # RMSE 0.03420398170626725
...
lstm_model.save("Model/BiLSTM_model.h5")
...
import json
json.dump(history.history,open("BiLSTM_history.json","w"))


# In[26]:


model_restored=tf.keras.models.load_model("Model/BiLSTM_model.h5")
