...
model.save("Model/cnn_lstm_for_组合LSTM_model.h5")
...
import json
json.dump(history.history,open("cnn_lstm_for_组合LSTM_history.json","w"))


# In[13]:


model_restored=tf.keras.models.load_model("Model/cnn_lstm_for_组合LSTM_model.h5")
...
lstm_model=LSTM(units=80,return_sequences=True,kernel_initializer=initializers.glorot_uniform(seed=2022),recurrent_initializer=initializers.orthogonal(seed=2022))(inputs)#LSTM1层
lstm_model=LSTM(units=60,return_sequences=True,kernel_initializer=initializers.glorot_uniform(seed=2022),recurrent_initializer=initializers.orthogonal(seed=2022))(lstm_model)#LSTM1层
#model=LSTM(units=60,return_sequences=True,kernel_initializer=initializers.glorot_uniform(seed=2022),recurrent_initializer=initializers.orthogonal(seed=2022))(model)#LSTM1层
#mdel=Dropout(0.5)
...
lstm_model.save("Model/组合LSTM_model.h5")
...
import json
json.dump(history.history,open("组合LSTM_history.json","w"))


# In[28]:


model_restored=tf.keras.models.load_model("Model/组合LSTM_model.h5")
